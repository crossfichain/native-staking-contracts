...
contract DeploymentCoordinator {
    ...
    function deploySystem(address adminAddress) external returns (address) {
        ...
        nativeStakingManagerProxy = address(nativeStakingManagerProxyContract);
    ...
    function setupRoles(address adminAddress) private {
        ...
        NativeStakingManager(nativeStakingManagerProxy).grantRole(adminRole, adminAddress);
        ...
        NativeStakingManager(nativeStakingManagerProxy).renounceRole(adminRole, address(this));
    }
} 